...
const responseSchema = {
  ...
  properties: {
    ...
    bulletRewrites: {
      type: Type.ARRAY,
      description: "5-10 weak bullet rewrites to be stronger and ATS-friendly",
      items: {
        type: Type.OBJECT,
    ...
    summary: { type: Type.STRING, description: "One short paragraph verdict" },
  },
};
...
function buildPrompt({ rawText, targetRole }) {
  ...
  return [
    ...
    "Return exactly 5 prioritized issues, 5 standout strengths, and 5-10 weak bullet rewritten to be stronger, quantified, and ATS-friendly.",
