...
const responseSchema = {
  ...
  properties: {
    ...
    education: {
      ...
      items: {
        type: Type.OBJECT,
        required: ["degree", "school", "period", "details"],
        properties: {
...
function buildPrompt(rawText) {
  return [
    ...
    "- experience: jobs most recent first, with company, role, period (preserve origianl date format), location if available, and bullet points",
