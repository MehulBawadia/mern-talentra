...
function UploadVisual() {
  return (
    <div className="relative rounded-2xl bg-linear-to-br from-(--surface-2)/60 to-(--surface) border border-(--border) p-4">
      <div className="flex items-center gap-3">
        <div className="relative shrink-0">
          <div className="absolute -inset-1 rounded-2xl bg-(--accent-soft) blur-md opacity-70" />
          <div className="relative h-11 w-11 rounded-2xl bg-(--surface) border border-(--border) shadow-card flex items-center justify-center">
            <div
...
function AnalyzeVisual() {
  ...
  return (
    <div className="relative rounded-2xl bg-linear-to-br from-[var(--surface-2)]/60 to-[var(--surface)] border border-[var(--border)] p-4">
    ...
    <div className="relative rounded-2xl bg-linear-to-br from-[var(--surface-2)]/60 to-[var(--surface)] border border-[var(--border)] p-4">
      ...
      <div className="mt-3 pt-3 border-t border-[var(--border)] flex items-center justify-between">
        ...
        <div className="text-[10px] text-[var(--ink-muted)] tabular-nums">
          <span className="text-[var(--success)] font-semibold">+24 pts</span>{" "}
          from V1
        </div>
      </div>
    </div>
